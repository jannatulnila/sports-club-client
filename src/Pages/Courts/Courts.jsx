...
//   return (
//     <div className="p-4">
//       <h2 className="text-2xl font-bold mb-6 text-center text-secondary">All Courts</h2>
...
//           <div key={court._id} className="card bg-base-100 shadow-lg h-full flex flex-col">
//   <figure>
//     <img
//       src={court.image}
//       alt={court.name}
