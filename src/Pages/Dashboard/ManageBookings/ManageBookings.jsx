...
//             <h2 className="text-2xl font-bold text-secondary text-center mb-4">Manage Confirmed Bookings</h2>
...
//                 <tr
//                   key={booking._id}
//                   className="hover:bg-gray-50 dark:hover:bg-gray-700 text-black dark:text-gray-200"
//                 >
//                   <td className='text-black'>{idx + 1}</td>
//                   <td className='text-black'>{booking.email}</td>
//                   <td className='text-black'>{booking.courtType}</td>
...
//                   <td className='text-black'>{new Date(booking.date).toLocaleDateString()}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
